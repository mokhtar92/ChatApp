 ...
 */
public class FXMLServerAlreadyOnlineController implements Initializable {
    ...
    @FXML
    private Label serverIsRunningLable;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        Platform.runLater(new Runnable() {
            @Override
            public void run() {
                myStage = (Stage) serverIsRunningLable.getScene().getWindow();
            }
        });
    }
